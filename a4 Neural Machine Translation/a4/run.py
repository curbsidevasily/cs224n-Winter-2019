...
def evaluate_ppl(model, dev_data, batch_size=32):
    ...
    with torch.no_grad():
        for src_sents, tgt_sents in batch_iter(dev_data, batch_size):
            print(f'input size: {len(src_sents)}, out size: {len(tgt_sents)}')
...
def main():
    ...
    assert(torch.__version__[
           :3] == "1.0"), "Please update your installation of PyTorch. You have {} and you should have version 1.0.0".format(torch.__version__)
